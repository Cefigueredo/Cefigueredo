...
| [**Employee-desertion-detector**](https://github.com/Cefigueredo/Employee-desertion-detector) `Python` | Predicting employee churn from HR data with scikit-learn, end to end | today |
